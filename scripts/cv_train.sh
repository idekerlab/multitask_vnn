...
python -u $pyScript -onto $ontfile -gene2id $gene2idfile -cell2id $cell2idfile -train $traindatafile \
	...
	-tasks $taskfile -model $modeldir -genotype_hiddens 12 -lr 0.0002 -cuda $cudaid -epoch 300 \
	-batchsize 64 -optimize 1 -tuned_hyperparams $hyperparamsfile > "${modeldir}/train.log"
